            ...
            >
              ...
              >
                <div className="flex items-start sm:items-center gap-3 sm:gap-4 min-w-0">
                  <span className="text-[10px] font-mono uppercase tracking-widest text-violet-500 flex-shrink-0 pt-0.5 sm:pt-0">
                    {mod.number}
                  </span>
                ...
                <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 ml-2">
                  ...
                  <div className={`flex h-6 w-6 items-center justify-center rounded-full border flex-shrink-0 transition-colors ${
                    open === i
              ...
              <AnimatePresence initial={false}>
                {open === i && (
                  ...
                  >
                    <ul className="px-4 sm:px-6 pb-6 space-y-2.5 border-t border-white/[0.06] pt-4">
