...
function TestimonialCard({ name, role, text, rating }: typeof testimonials[0]) {
  return (
    <div className="shrink-0 w-80 rounded-xl border border-white/8 bg-[#0d0d0d] p-6 hover:border-violet-500/25 transition-colors">
...
export default function EditableTestimonials() {
  ...
  const handleEdit = (data: TestimonialData) => {
    setEditingItem({
      type: 'testimonials',
      data,
    })
      ...
      <section className="bg-black px-6 py-24 sm:px-8 overflow-hidden">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-2xl text-center mb-14">
            ...
            <p className="mt-4 text-base text-zinc-400">{testimonialData.introText}</p>
          </div>
        </div>
