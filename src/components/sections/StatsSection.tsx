...
const stats = [
  { value: 500, suffix: '+', label: 'Active Learners', sub: 'and growing every week' },
  { value: 98, suffix: '%', label: 'Completion Rate', sub: 'students finish the course' },
  { value: 14, suffix: 'x', label: 'Avg ROI Improvement', sub: 'after 3 months of practice' },
  { value: 4, suffix: '.9★', label: 'Average Rating', sub: 'across all cohorts' },
]
...
function StatCard({ value, suffix, label, sub, inView }: typeof stats[0] & { inView: boolean }) {
  ...
  return (
    <motion.div
      ...
      className="relative rounded-xl border border-white/[0.08] bg-[#0d0d0d] p-6 overflow-hidden group hover:border-violet-500/30 transition-colors"
    >
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-6 lg:grid-cols-2 items-center">
          ...
          <motion.div
            ...
            className="rounded-xl border border-white/[0.08] bg-[#0d0d0d] p-6 flex flex-col gap-4"
          >
