    ...
    <section id="community" className="scroll-mt-20 bg-black px-6 py-24 sm:px-8 lg:px-10">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="rounded-xl border border-white/[0.08] bg-[#0d0d0d] overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 divide-y divide-white/[0.08] lg:divide-y-0 lg:divide-x lg:divide-white/[0.08]">
            ...
            <div className="lg:col-span-7 p-8 md:p-10 flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="h-10 w-10 flex-shrink-0 rounded-lg border border-white/[0.08] bg-white/5 flex items-center justify-center text-violet-400">
                ...
                <ul className="mt-8 space-y-3">
                  {[
                    ...
                    <li key={text} className="flex items-start gap-3">
                      <span className="mt-0.5 flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full border border-violet-500/30 bg-violet-500/10">
            ...
            <div className="lg:col-span-5 p-8 md:p-10 flex flex-col justify-between">
              <div className="space-y-5">
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="flex items-stretch gap-2">
                    <div className="flex-1 flex items-center rounded-lg border border-white/[0.08] bg-black px-3.5 py-2.5">
                      <span className="font-mono text-sm tracking-widest text-violet-400 font-bold">{referralCode}</span>
                    </div>
                    <button
                      onClick={handleCopy}
              ...
              <div className="grid grid-cols-2 gap-3 mt-8 pt-6 border-t border-white/[0.08]">
                <div className="rounded-lg border border-white/[0.08] bg-black p-4 text-center">
